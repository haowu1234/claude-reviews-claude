...
> → 深度解析: [EP12: 启动与引导](12-startup-bootstrap.md) | [EP16: 基础设施](16-infrastructure-config.md)
...
> → 深度解析: [EP02: 工具系统](02-tool-system.md) | [EP06: Bash 引擎](06-bash-engine.md)
...
> → 深度解析: [EP10: 上下文组装](10-context-assembly.md) | [EP11: 压缩系统](11-compact-system.md)
...
> → 深度解析: [EP07: 权限管道](07-permission-pipeline.md) | [EP06: Bash 引擎](06-bash-engine.md)
...
> → 深度解析: [EP03: 协调器](03-coordinator.md) | [EP08: Agent 集群](08-agent-swarms.md)
...
> → 深度解析: [EP04: Plugin 系统](04-plugin-system.md) | [EP05: Hook 系统](05-hook-system.md)
...
> → 深度解析: [EP12: 启动](12-startup-bootstrap.md) | [EP14: UI 与状态](14-ui-state-management.md) | [EP16: 基础设施](16-infrastructure-config.md)
